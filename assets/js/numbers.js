...
const numbersSectionTop = numbersSection.offsetTop + numbersSection.offsetHeight - window.innerHeight;
...
const animateNumbersSection = () => {
    ...
    if (numbersSection.classList.contains('active')) {
        animateValue(numOne, 0, 410, duration);
        animateValue(numTwo, 0, 507, duration);
